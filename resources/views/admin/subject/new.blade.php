            ...
            <div class="col-lg-6 col-sm-6 col-xs-12">
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <div>
                           {!! Form::open(['url' => 'admin/new-subject','action'=>'post','role'=>'form']) !!}
                                <div class="form-group">
                                 	{!! Form::label('name','Subject Name') !!}
            						{!! Form::text('name',null,['class'=>'form-control','placeholder' => 'e.g Mathematics']) !!}
                                </div>
                                 <div class="form-group">
                                ...
                                {!! Form::submit('Add Subject',['class' => 'btn btn-blue']) !!}
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
