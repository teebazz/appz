                ...
                <div class="widget flat radius-bordered">
                    ...
                    <div class="widget-body">
                        <div id="registration-form">
                           ...
                           {!! Form::model($student,['action' => 'post','url' =>['admin/edit-student',$student->id],'files' => true])!!}
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <span class="input-icon icon-right">
                                                {!! Form::select('parent_id',$parents,$student->parent_id,['class' =>'form-control'])!!}
                                     ...
                                     <div class="col-sm-4">
                                        <div class="form-group">
                                            <span class="input-icon icon-right">
                                                 {!! Form::select('division_id',$divisions,$student->division_id,['class' =>'form-control','id'=>'division'])!!}
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <span class="input-icon icon-right">
                                                 {!! Form::select('class_id',$classes,$student->class_id,['class' =>'form-control','id'=>'class'])!!}
                                 ...
                                 <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <span class="input-icon icon-right">
                                                {!! Form::select('section_id',$sections,$student->section_id,['class' =>'form-control','id'=>'section'])!!}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <span class="input-icon icon-right">
                                                {!! Form::select('state_id',$states,$student->state_id,['class' =>'form-control'])!!}
                                            </span>
                                        </div>
                                    </div>
                                </div>
