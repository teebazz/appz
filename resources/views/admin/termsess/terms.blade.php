...
<div class="row">
	<div class="col-xs-12 col-md-12">
		<a class="btn btn-success pull-left" href="{{ url('admin/new-class') }}"><i class="fa fa-plus"></i> Add New Term</a>
		<a class="btn btn-success pull-right" href="{{ url('admin/new-section') }}"><i class="fa fa-plus"></i> Add New Session</a>
		<hr>
	</div>
	<div class="col-xs-12 col-md-12">
        <div class="tabbable">
                   ...
                   <table class="table table-bordered table-hover table-striped" id="searchable">
			        ...
			        <tbody>
			            ...
			            <tr>
			                ...
			                <td class="center "><a href="{{ url('admin/edit-class',$term->id)}}" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i> Edit</a> <a href="#" class="btn btn-danger btn-xs delete"><i class="fa fa-trash-o"></i> Delete</a></td>
			            </tr>
			            @endforeach
			        </tbody>
			    </table>
